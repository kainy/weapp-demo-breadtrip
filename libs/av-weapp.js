...
var getSessionToken = _require.getSessionToken;
...
var isNullOrUndefined = _require.isNullOrUndefined;
...
AV._encode = function (value, seenObjects, disallowObjects) {
  var full = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3];
...
var _ = __webpack_require__(0);
var Promise = __webpack_require__(1);
var localStorage = __webpack_require__(46);
...
module.exports = {
  polyfill: function polyfill() {
    var target = arguments.length <= 0 || arguments[0] === undefined ? global || window : arguments[0];
...
var _ = __webpack_require__(0);
var cos = __webpack_require__(42);
var qiniu = __webpack_require__(43);
var s3 = __webpack_require__(44);
var AVError = __webpack_require__(3);
var AVRequest = __webpack_require__(2).request;
var Promise = __webpack_require__(1);
...
module.exports = function (AV) {
  ...
  _.extend(AV.File.prototype, /** @lends AV.File.prototype */{
    ...
    toJSON: function toJSON(key, holder) {
      var seenObjects = arguments.length <= 2 || arguments[2] === undefined ? [this] : arguments[2];
...
var ensureArray = _require.ensureArray;
...
module.exports = function (AV) {
  ...
  _.extend(AV.Query.prototype, /** @lends AV.Query.prototype */{
    ...
    _createRequest: function _createRequest() {
      var params = arguments.length <= 0 || arguments[0] === undefined ? this.toJSON() : arguments[0];
      var options = arguments[1];
...
module.exports = function (AV) {
  ...
  AV.Status.countUnreadStatuses = function (owner) {
    var inboxType = arguments.length <= 1 || arguments[1] === undefined ? 'default' : arguments[1];
    var options = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];
...
var comments = ["Weapp" || 'Node.js'].concat(__webpack_require__(40));
